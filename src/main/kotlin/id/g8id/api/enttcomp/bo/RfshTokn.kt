...
//        }
        ...
        fun findByUserIdAndVlue(userId: String, vlue: String): RfshTokn? {
            return find("userId = :userId and vlue = :vlue", Parameters.with("userId", userId).and("vlue", vlue)).firstResult()
        }

        fun findByUserIdAndPrvsVlue(userId: String, vlue: String): RfshTokn? {
            return find("userId = :userId and prvsVlue = :prvsVlue", Parameters.with("userId", userId).and("prvsVlue", vlue)).firstResult()
        }
