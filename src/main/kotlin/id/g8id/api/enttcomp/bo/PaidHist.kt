...
class PaidHist : PanacheMongoEntity {
  ...
  companion object: PanacheMongoCompanion<PaidHist> {
    ...
    fun findAllByUserId(userId: String): List<id.g8id.api.enttcomp.fo.PaidHist> {
      return id.g8id.api.enttcomp.fo.PaidHist.find("userId", userId).list()
    }

    fun findConfirmedItem(crtrId: String): List<id.g8id.api.enttcomp.fo.PaidHist> {
      val sevenDaysAgo = LocalDateTime.now().minusDays(7)
      return id.g8id.api.enttcomp.fo.PaidHist.find(
